...
<body class="productPage">
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#">
                  ...
                  @endphp
                  <span class="aa-cart-notify" id="totalItem">{{$totalcount}}</span>
                </a>
                <div class="aa-cartbox-summary" id="product">
                  <ul>
                    <?php
                    $totalprice = 0;
                    ?>
                    ...
                    @endphp
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="{{asset('storage/media/'.$data->image)}}" alt="img"></a>
              ...
              <div class="aa-search-box">
                <form action="">
                  ...
                  <button type="button" onclick="searchfun()"><span class="fa fa-search"></span></button>
                </form>
              </div>
              <!-- / search box -->
            </div>
  ...
  if (isset($_COOKIE['login_email']) && isset($_COOKIE['login_password'])) {
    $db_email = $_COOKIE['login_email'];
    $db_pwd = $_COOKIE['login_password'];
        ...
        <div class="modal-body">
          ...
          <div id="popup_login">
            ...
            <form class="aa-login-form" action="" id="frmlogin">
              ...
              <input type="email" name="login_email" placeholder="email" value="{{$db_email}}">
              <label for="">Password<span>*</span></label>
              <input type="password" name="login_pwd" placeholder="Password" value="{{$db_pwd}}">
              <button class="aa-browse-btn" type="submit">Login</button>
              <label for="rememberme" class="rememberme"><input type="checkbox" id="rememberme" name="rememberme" {{$check}}> Remember me </label>
              @csrf
          ...
          <div id="popup_forgot" style="display: none;">
            ...
            <form class="aa-login-form" action="" id="frmforgot">
              ...
              <button class="aa-browse-btn" type="submit">Send Mail</button>
              
              @csrf
              <p class="aa-lost-password"><a href="javascript:void(0)" onclick="show_login()">Login Here?</a></p>
